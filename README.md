...
if game:GetService("ReplicatedStorage").Effect.Container:FindFirstChild("Respawn") then
	...
	DisplayButton.TextLabel.Text = "NoName Hub"
...
local TestTab = Page:CreateSection({
    Name = "// Mian Function \\", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})

TestTab:AddToggle({
    Name = "Start Kaitun  |  ทำของอาสจะน้อย ",
	Value = true,
...
TestTab:AddToggle({
    Name = "Fast Farm 10-300 | ถึง300ปิดด้วย",
	Value = false,
    Callback = function(value)
    _G.Farmfast = true
	...
	pcall(function()
		while wait() do
			if _G.Farmfast and World1 then
				if game.Players.LocalPlayer.Data.Level.Value >= 10 or game.Players.LocalPlayer.Data.Level.Value <= 75 then
					_G.AutoFarm = false
					_G.Farmfast = true
				end
			end
...
spawn(function()
	pcall(function()
		while wait() do
			if _G.Farmfast and World1 then
				if game.Players.LocalPlayer.Data.Level.Value >= 101 then
					_G.Farmfast = false
					_G.AutoFarm = true
				end
			end
